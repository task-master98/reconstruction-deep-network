        ...
        while i < len(lines):
            if lines[i].startswith("intrinsics_matrix"):
                ...
                if intrinsic_info is not None:
                    ...
                    image_pairs.append((depth_image, rgb_image, matrix_values, intrinsic_info))
                else:
...
def pcd_color_vectorized(depth_image, rgb_image, intrinsic_params, matrix_values):
    ...
    fx, cx, fy, cy = intrinsic_params[0], intrinsic_params[2], intrinsic_params[4], intrinsic_params[5]
